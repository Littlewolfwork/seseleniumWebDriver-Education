...
namespace csharp_example
{
    ...
    public class MyFirstTest
    {
        ...
        public void AllStikersChrome()
        {
            ...
            String CampaignPriceWeightMain = driver.FindElement(By.CssSelector("#box-campaigns .campaign-price")).GetCssValue("fontWeight");
            int CampaignPriceWeightMainInt = Convert.ToInt32(CampaignPriceWeightMain);
            String CampaignPriceSizeMain = driver.FindElement(By.CssSelector("#box-campaigns .campaign-price")).GetCssValue("fontSize");
            float CampaignPriceSizeMainInt = ConverSize(CampaignPriceSizeMain);
            String RegularPriceSizeMain = driver.FindElement(By.CssSelector("#box-campaigns .regular-price")).GetCssValue("fontSize");
            ...
            String CampaignPriceWeight = driver.FindElement(By.CssSelector("#box-product .campaign-price")).GetCssValue("fontWeight");
            int CampaignPriceWeightInt = Convert.ToInt32(CampaignPriceWeight);
            String CampaignPriceSize = driver.FindElement(By.CssSelector("#box-product .campaign-price")).GetCssValue("fontSize");
            float CampaignPriceSizeInt = ConverSize(CampaignPriceSize);
            String RegularPriceSize = driver.FindElement(By.CssSelector("#box-product .regular-price")).GetCssValue("fontSize");
